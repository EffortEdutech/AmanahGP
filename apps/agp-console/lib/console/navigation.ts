...
export const CONSOLE_NAV_GROUPS = [
  ...
  },
  {
    ...
    description: "MAIN/JAIN oversight without super-admin access to private org internals.",
    items: [
      { href: "/authority", label: "Authority Dashboard", icon: ShieldCheck },
      { href: "/authority/organisations", label: "Authority Registry", icon: Building2 },
      { href: "/authority/submissions", label: "Submissions", icon: ClipboardList },
      { href: "/authority/obligations", label: "Obligations", icon: BookCheck },
      { href: "/authority/exceptions", label: "Exceptions", icon: Bell },
      { href: "/authority/cases", label: "Review Cases", icon: Gavel },
      { href: "/authority/evidence", label: "Evidence", icon: FileSearch },
      { href: "/authority/actions", label: "Corrective Actions", icon: Rocket },
      { href: "/authority/reports", label: "Reports", icon: ScrollText },
      { href: "/authority/policy", label: "Policy", icon: BookCheck },
      { href: "/authority/activity", label: "Activity", icon: Radio },
    ],
  },
  {
