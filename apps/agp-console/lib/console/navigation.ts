...
export const CONSOLE_NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/scholar-approval", label: "Scholar Approval", icon: BookCheck },
    ],
  },
  {
...
export const CONSOLE_CRITICAL_FLOW = [
  ...
  { label: "Scholar Approval", href: "/scholar-approval", purpose: "Shariah and scholarly routing before final approval." },
