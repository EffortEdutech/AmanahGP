        ...
        <aside className="panel sidebar">
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: "#94a3b8", marginTop: 1 }}>Governance Control Plane</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div className="avatar avatar-green" style={{ width: 34, height: 34, fontSize: 12 }}>
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              ...
              <div style={{ fontSize: 11, color: "#64748b", marginTop: 1 }}>{roleLabel}</div>
            </div>
          </div>
