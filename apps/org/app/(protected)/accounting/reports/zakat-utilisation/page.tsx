...
export default async function ZakatUtilisationPage({
  ...
  const org      = relationOne<{ id: string; name: string; oversight_authority: string | null; fund_types: string[] }>(membership.organizations);
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-5 space-y-1">
        ...
        <p className="text-[11px] text-gray-500 text-center">
          Zakat Utilisation Report Â· Financial Year {selectedYear}
        </p>
