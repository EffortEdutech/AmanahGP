        ...
        <div className="rounded-lg border border-red-200 bg-red-50 p-4 space-y-2">
          ...
          {riskFlags.no_close_3mo && (
            <p className="text-[11px] text-red-700">
              ...
              <a href={`/org/${orgId}/accounting/close`} className="underline ml-1">Close now →</a>
            </p>
          )}
          ...
          {riskFlags.audit_overdue && (
            <p className="text-[11px] text-red-700">
              ...
              <a href={`/org/${orgId}/compliance`} className="underline ml-1">Review compliance →</a>
            </p>
          )}
        </div>
      )}
        ...
        <section className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            {recommendations.map((rec) => {
              ...
              return (
                <a key={rec.action} href={`/org/${orgId}${rec.href}`}
      ...
      <section className="space-y-3">
        ...
        {events && events.length > 0 ? (
          ...
          <div className="rounded-lg border border-dashed border-gray-300 bg-gray-50 p-6 text-center">
            ...
            <a href={`/org/${orgId}/accounting/close`} className="text-[11px] text-emerald-600 hover:underline mt-1 block">
