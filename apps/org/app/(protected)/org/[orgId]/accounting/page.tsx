    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      {yearClose && (
        <div className="rounded-lg bg-emerald-50 border border-emerald-200 p-3 flex items-center justify-between">
          ...
          <a href={`/org/${orgId}/accounting/statements`}
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link href={`/org/${orgId}/accounting/statements`}
        ...
        {isManager && !yearClose && (
          <Link href={`/org/${orgId}/accounting/close`}
            className="rounded-lg border border-gray-200 bg-white p-4 hover:border-emerald-300
                       hover:shadow-sm transition-all flex items-center gap-3">
      ...
      <div className="rounded-lg bg-blue-50 border border-blue-200 p-4">
        ...
        <a href={`/org/${orgId}/accounting/statements`} className="text-[11px] text-blue-700 hover:underline mt-1 block">
