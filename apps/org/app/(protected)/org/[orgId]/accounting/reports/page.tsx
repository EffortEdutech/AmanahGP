...
const REPORTS = [
  {
    path: '/accounting/reports/statement-of-financial-position',
    icon:     '⊞',
  ...
  {
    path: '/accounting/reports/statement-of-activities',
    icon:     '≡',
  ...
  {
    path: '/accounting/reports/fund-changes',
    icon:     '◎',
  ...
  {
    path: '/accounting/reports/zakat-utilisation',
    icon:     '★',
  ...
  {
    path: '/accounting/reports/project-fund',
    icon:     '▦',
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {REPORTS.map((report) => (
          <a key={report.path} href={`/org/${orgId}${report.path}`}
