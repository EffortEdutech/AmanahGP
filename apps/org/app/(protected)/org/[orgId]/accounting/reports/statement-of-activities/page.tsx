    ...
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <MonthYearPicker
            ...
            basePath={`/org/${orgId}/accounting/reports/statement-of-activities`}
          />
      </div>
      ...
      {(activities ?? []).length === 0 && (
        <div className="rounded-lg border border-dashed border-gray-300 bg-gray-50 p-6 text-center">
          ...
          <a href={`/org/${orgId}/accounting/transactions/new`} className="text-[12px] text-emerald-600 hover:underline mt-1 block">
