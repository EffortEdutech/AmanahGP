...
// v8.2 build fix: usePathname() can return null in Next.js. Keep pathname null-safe.
          ...
          <div className="flex items-start justify-between gap-1">
            ...
            {hasMultiOrg && (
              <button
                ...
                className="mt-0.5 flex-shrink-0 rounded px-1 py-0.5 text-[10px] text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-700"
              >
                ⇅
              </button>
            )}
          ...
          {switcherOpen && hasMultiOrg && (
            <div className="mt-2 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
              {orgs.map((org) => (
                ...
                >
                  <span className="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded bg-emerald-100 text-[9px] font-bold text-emerald-700">
