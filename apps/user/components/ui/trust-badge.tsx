...
// Sprint 24
//
// The primary trust signal donors see on org profiles and donation pages.
...
const GRADE_STYLES: Record<Grade, {
  ring: string; bg: string; shield: string; label: string; text: string; score: string;
}> = {
  platinum: {
...
export function TrustBadge({
  score, grade, gradeLabel, gradeSublabel, lastUpdated, size = 'md', certified,
}: TrustBadgeProps) {
